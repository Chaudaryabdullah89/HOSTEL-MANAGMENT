    ...
    <div>
      <div className="flex md:flex-row flex-col justify-between px-4">
        <div className="mt-4 ">
          ...
          <p className="text-muted-foreground leading-loose" >Manage guests in your assigned hostels only.</p>
      ...
      < div className="grid md:grid-cols-2 p-4 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-0">
            <CardTitle className="text-sm font-medium">My Hostel Guests</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">14</div>
            <p className="text-xs text-muted-foreground">
              Guests in assigned hostels
            </p>
          </CardContent>
        </Card>
        <Card>
