...
import { Plus, Filter, Users, TrendingUp, ChevronDown, Search, Edit, Wifi, Tv, Wind, Delete, Bin, Trash, Clock, User, Bed, Calendar, CardSim, CreditCard, UserStar, Eye } from 'lucide-react'
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="pt-3 border-t">
                  <Button
                    onClick={() => router.push(`/dashboard/admin/user/${guest.id}`)}
                    variant="outline"
                    className="w-full"
                    size="sm"
                  >
